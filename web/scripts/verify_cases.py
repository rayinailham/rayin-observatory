...
async def inspect(page, case, width, height, shots):
    ...
    flow = {'crosscheck': '.inspection-steps li', 'surgeline': '.dispatch-steps li', 'driftwatch': '.monitor-steps li', 'duewatch': '.time-steps li', 'brandwall': '.brand-steps li'}.get(case['id'], '.signal-flow li')
