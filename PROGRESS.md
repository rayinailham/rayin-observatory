...
- [x] Fix F1 pasca-gate (2026-09-24, atas permintaan pemilik): video demo tanpa `<source>` di markup, src dipasang saat play → WebKit headless case file 0/10 crash (sebelumnya 10/10). Belum di-deploy
